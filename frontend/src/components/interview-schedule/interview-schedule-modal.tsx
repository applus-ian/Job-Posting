...
export function InterviewScheduleModal({ isOpen, onClose, onSchedule }: InterviewScheduleModalProps) {
      ...
      <DialogContent className="sm:max-w-md p-0 rounded-lg overflow-hidden">
        <DialogHeader className="p-6 pb-2 border-b">
          <div className="flex justify-between items-center">
            <DialogTitle className="text-xl font-semibold text-gray-800">Schedule New Interview</DialogTitle>
          </div>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="p-6 pt-4 space-y-5">
          <div className="space-y-2">
            ...
            >
              <SelectTrigger className={`w-full border-gray-200 ${errors.applicant ? 'border-red-300 ring-red-100' : ''}`}>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Select 
                ...
                value={interviewer}
              >
                <SelectTrigger className={`w-full border-gray-200 ${errors.interviewers ? 'border-red-300 ring-red-100' : ''}`}>
            ...
            {errors.interviewers && <p className="text-xs text-red-500 mt-1">{errors.interviewers}</p>}
            ...
            {formData.interviewers.length > 0 && (
              <div className="mt-2 space-y-1.5">
                {formData.interviewers.map((interviewerId, index) => {
                  ...
                  return (
                    <div key={index} className="flex items-center justify-between bg-gray-50 p-2.5 rounded-md border border-gray-100">
                      <span className="text-sm">{interviewer?.label || interviewerId.replace(/-/g, ' ')}</span>
                      <Button 
                        type="button"
                        variant="ghost" 
                        size="icon" 
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger className={`w-full border-gray-200 ${errors.mode ? 'border-red-300 ring-red-100' : ''}`}>
