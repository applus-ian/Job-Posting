...
import { TagInput } from "@/components/job/TagInput";
...
export function JobPostingForm({ jobposting }: { jobposting: JobPosting | null }) {
  const { form, onSubmit, error } = useJobPostingForm(jobposting);
                ...
                <TooltipProvider>
                  <FloatingLinkContext>
                    ...
                    <DescriptionSyncPlugin
                      ...
                      initialDescription={jobposting?.description}
                    />
                  </FloatingLinkContext>
                </TooltipProvider>
              </LexicalComposer>
