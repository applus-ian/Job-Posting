...
interface AllApplicationTableProps<T> {
              ...
              <div className="grid gap-4">
                ...
                {table.getColumn("employment_type") && (
                  <DataTableFilter
                    ...
                    options={Array.from(
                      new Set(data.map((item: any) => item.job_posting?.employment_type).filter(Boolean))
                    ).map((employment_type) => ({
                ...
                {table.getColumn("employment_level") && (
                  <DataTableFilter
                    ...
                    options={Array.from(
                      new Set(data.map((item: any) => item.job_posting?.employment_level).filter(Boolean))
