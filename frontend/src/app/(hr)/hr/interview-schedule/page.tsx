...
import {
  CalendarView,
  Interview as CalendarInterview,
} from "@/components/interview-schedule/CalendarView";
import { ListView } from "@/components/interview-schedule/ListView";
import { Card } from "@/components/ui/card";
import {
  InterviewScheduleModal,
  InterviewFormData,
} from "@/components/interview-schedule/InterviewScheduleModal";
import { sampleInterviews } from "@/components/interview-schedule/sample-data";
        ...
        <div className="flex justify-end mb-2 ">
          <div className="flex items-center gap-2 w-[300px]">
            ...
            <Button
              variant="outline"
              size="icon"
              className="h-8 w-8 rounded-sm border-gray-200 flex-shrink-0"
            >
        ...
        <div className="flex justify-center w-full">
          <Card className="w-full p-2 sm:p-4 overflow-hidden">
            <div className="bg-white rounded-sm h-full">
              ...
              {view === "list" && <ListView interviews={interviews} />}
            </div>
          </Card>
        </div>
      </div>
